		  ...
		  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="550" id="AutoNumber1">
		  	...
		  	<tr>
		  	     <td width="100%" align="center"><br><br>
					<form method="POST" action="contact_agent_process.php">
					<input type="hidden" name="id" value="<?PHP echo "$userid"; ?>">
					<input type="hidden" name="mfname" value="<?PHP echo "$_SESSION[mfirst_name]"; ?>">
					<input type="hidden" name="mlname" value="<?PHP echo "$_SESSION[mfirst_name]"; ?>">
					<input type="hidden" name="agency_name" value="<?PHP echo "$agency_name"; ?>">
					<input type="hidden" name="group_name" value="<?PHP echo "$mgroup"; ?>">
		  	 ...
		  	 <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="550" align="left" height="155">
		  	    ...
		  	    <tr><td align="center" height="19" colspan="2" width="550">You are now sending a request for audition to <b><?PHP echo "$agency_name"; ?></b>.An email message will automatically be sent to <b><?PHP echo "$agency_name"; ?></b> with this message.<br>
		  &nbsp;</td></tr>


		          <tr><td align="center" height="19" width="1">Date:</td>
		            <td align="center" height="19" width="550">
		            <input name="date" size="20" style="float: left"></td></tr>
		          ...
		          <tr><td align="center" height="19" colspan="2" width="550"><input type="submit" name="submit" value="Send Request"></td></tr>
