		  ...
		  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="550" id="AutoNumber1">
		  	...
		  	<tr>
		  	     <td width="100%" align="center"><br><br>
					<form method="POST" action="contact_musician_process.php">
		  	 ...
		  	 <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="550" align="left" height="155">
		  	    ...
		  	    <tr><td align="center" height="19" colspan="2" width="550">You are about to contact <b><?PHP echo "$group_name"; ?></b>. An email message will be
		             sent to <b><?PHP echo "$group_name"; ?></b><br>
		  &nbsp;</td></tr>
			   ...
			   <tr><td align="center" height="19" width="1">Subject:</td>
		            <td align="center" height="19" width="550">
		            <input name="formsubject" size="20" style="float: left" value=""></td></tr>

		          <tr><td align="center" height="19" width="1">Email:</td>
		            <td align="center" height="19" width="550">
		            <input name="formemail" size="20" style="float: left" value="<?PHP echo $_SESSION[memail_address]; ?>"></td></tr>
		          ...
		          <tr><td align="center" height="19" colspan="2" width="550"><input type="submit" name="submit" value="Send to <?PHP echo "$group_name"; ?>"></td></tr>
