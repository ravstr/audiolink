		  ...
		  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="550" id="AutoNumber1">
		  	...
		  	<tr>
		  	     <td width="100%" align="center"><br><br>
					<form method="POST" action="agent_ban_musician_process.php">
		  	 ...
		  	 <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="550" align="left" height="155">
		  	    ...
		  	    <tr><td align="center" height="19" colspan="2" width="550">You are about to ban <b><?PHP echo "$group_name"; ?></b> from making any requests with you. An email message will be
		            automatically sent to <b><?PHP echo "$group_name"; ?></b>.<br>
		  &nbsp;</td></tr>
		          ...
		          <tr><td align="center" height="19" colspan="2" width="550"><input type="submit" name="submit" value="Ban <?PHP echo "$group_name"; ?>"></td></tr>
