    	...
    	?>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="550" id="AutoNumber1">
		  	...
		  	<?
				...
				$sql1 = "UPDATE Requests SET Status = 'Accept' WHERE MusicianId = '$id' AND AgentId=$_SESSION[agentuserid]";
				$sql_result = mysql_query($sql1,$connection) or die ('Could not insert data');
...
Your request has been accepted by $aname
...
mail($email_address, $subject, $message, "From: $sitename <$adminemail>\nX-Mailer: PHP/" . phpversion());
					...
					echo "Your message has been mailed to <b>$gname</b>";
