...
<table BORDER="0" CELLPADDING="0" CELLSPACING="0" STYLE="border-collapse: collapse" WIDTH="1000" bordercolorlight="#000000">
  ...
  ?>
	...
	$sql = mysql_query("SELECT * FROM AgencyProfile WHERE us_branch='$usbranch' OR genre='$Genre' OR employee_number='$empnum' OR state='$state' OR country='$country' OR agency_name='$keywords'");
  ...
  <center>
	...
	<tr bgcolor="#006699">
		             ...
		             <td><strong><font color="#FFFFFF">First Name</font></strong></td>
		 	    	 <td><strong><font color="#FFFFFF">Agency Name</font></strong></td>
		 	    	 <td><strong><font color="#ffffff">Location</strong></font></td>
		 	    	 <td><strong><font color="#ffffff">View Profile</strong></font></td>
		 	    	 <td><strong><font color="#ffffff">Make Request</strong></font></td>
     </tr>
     <?PHP
     	$rowcount = 0;
		while($row = mysql_fetch_array($sql)){
			 ...
			 if($type == 1) {
			 	echo "<Td><A href=\"agent_profile.php?id=$userid\">$last_name</a></td>";
			 }
			 	else {
			  ...
			  if($type == 1) {
			  	echo "<Td><A href=\"agent_profile.php?id=$userid\">Click here</a></td>";
			  }
			    else {
			    echo "<Td>$agency_name</td>";
			  }
			  ...
			  if($type == 1) {
			  	echo "<Td><A href=\"contact_agent.php?id=$userid&gname=$gname\">Request</a></td></tr>";
			  }
			  	else {
			  		echo "<Td>For Paid Customers Only <a href=\"musicianupgrade.php\">Click here to upgrade</a></td></tr>";
			  }
