...
<div align="center">
  <center>
    <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="550" id="AutoNumber1">
	   <tr>
	     <td width="100%"><br><br>
	     <form method="POST" action="search_musician_process.php">
	...
	<tr align="left" valign="top">
	 ...
	 <tr>
	     ...
	     <tr align="left" valign="top">
	            <td width="216" align="right" height="12"><b><font color="#000080">Keywords(optional)</font></td><td><input type="text" name="keywords"></td></tr>
