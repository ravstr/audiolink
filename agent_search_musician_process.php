...
<table BORDER="0" CELLPADDING="0" CELLSPACING="0" STYLE="border-collapse: collapse" WIDTH="1000" bordercolorlight="#000000">
  ...
  ?>
	...
	//include 'flag.php';
		...
		$sql1 = "SELECT paytype FROM AgencyProfile WHERE userid='$agentuserid'";
	    ...
	    $paytype=$row[0];
				...
				if($paytype == 0) {
				 	echo "<br><br>You can only view the list. Please upgrade your membership to view the full profile and rate members. Click <a href=\"agencyupgrade.php\">here</a> if you would like to upgrade";
			 }
	...
	<tr bgcolor="#006699">
     ...
     <?PHP
		...
		while($row = mysql_fetch_array($sql)){
			  ...
			  if($paytype == 1) {
			  	echo "<Td><A href=\"rate_musician.php?id=$userid&gname=$group_name\">Rate</a></td></tr>";
			  }
			  else {
			  	echo "<Td>Please click <a href=\"agencyupgrade.php\">here</a> to upgrade your membership</td>";
			  }
				$rowcount++;
		}
