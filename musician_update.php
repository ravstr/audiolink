...
<table BORDER="0" CELLPADDING="0" CELLSPACING="0" STYLE="border-collapse: collapse" WIDTH="1000" bordercolorlight="#000000">
  ...
  ?>
	...
	session_start();
	include 'db.php';
	$sql = "SELECT * FROM musician WHERE userid='$_SESSION[musicianuserid]'";
...
?>
 ...
 <FORM METHOD="POST" ACTION="musician_update_proccess.php"  name="Form1">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
      <tr>
        ...
        <td width="25%">
	                <font color="#000080">
	                <input type="text" name="username" maxlength="256" size="20" value="<?php printf($row['username']); ?>"></font></td>
      ...
      <tr>
        ...
        <td width="25%">
	                <font color="#000080">
	                <input type="password" name="password" maxlength="256" size="20" value="<?php printf($row['password']); ?>"></font></td>
        <td width="25%" align="right"><b><font color="#000080">*Verify Password</font></b></td>
        <td width="25%">
	                <font color="#000080">
	                <input type="password" name="password2" maxlength="256" size="23" value="<?php printf($row['password']); ?>"></font></td>
      </tr>
      <tr>
        <td width="25%" align="right"><b><font color="#000080">*Secret Question</font></b></td>
        <td width="25%">
	                <font color="#000080">
	                <input type="text" name="question" maxlength="256" size="20" value="<?php printf($row['question']); ?>"></font></td>
        <td width="25%" align="right"><b><font color="#000080">*Answer</font></b></td>
        <td width="25%">
	                <font color="#000080">
	                <input type="text" name="answer" maxlength="256" size="23" value="<?php printf($row['answer']); ?>"></font></td>
      </tr>
    </table>
<br><p>
    ...
    <table width="690" border="0" cellspacing="0" cellpadding="5" height="981">
          ...
          <tr align="left" valign="top">
            ...
            <td width="454" height="22">
              <div align="left">
                <font color="#000080">
                <input type="text" name="fname" maxlength="256" size="30" value="<?php printf($row['first_name']); ?>">
                </font>
              </div>
            </td>
          </tr>
          <tr align="left" valign="top">
            ...
            <td width="454" height="22">
              <div align="left">
                <font color="#000080">
                <input type="text" name="lname" maxlength="256" size="30" value="<?php printf($row['last_name']); ?>">
                </font>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td width="454" height="22">
              <font color="#000080">
              <input type="text" name="phone" maxlength="256" size="30" value="<?php printf($row['phone']); ?>"> </font>
            </td>
          </tr>
          <tr>
            ...
            <td width="454" height="22">
              <font color="#000080">
              <input type="text" name="email" maxlength="256" size="30" value="<?php printf($row['email_address']); ?>"> </font>
            </td>
          </tr>
          <tr>
            <td width="216" align="right" height="22"><font color="#000080"><b>
            ...
            <td width="454" height="22">
            <font color="#000080">
            <input type="text" name="website" size="30" maxlength="65" value="<?php printf($row['website']); ?>"></font></td>
          </tr>
          <tr>
            <td width="216" align="right" height="22"><font color="#000080"><b>
            ...
            <td width="454" height="22">
            <font color="#000080">
            <input type="text" name="groupname" size="30" maxlength="65" value="<?php printf($row['group_name']); ?>"></font></td>
          </tr>
          <tr align="left" valign="top">
          ...
          <tr align="left" valign="top">
            ...
            <td width="454" height="23">
              <div align="left">
                <font color="#000080">
                <input type="text" name="address1" maxlength="256" size="30" value="<?php printf($row['address1']); ?>">
                </font>
              </div>
            </td>
          </tr>
          <tr align="left" valign="top">
            ...
            <td width="454" height="22">
              <div align="left">
                <font color="#000080">
                <input type="text" name="address2" maxlength="256" size="30" value="<?php printf($row['address2']); ?>">
                </font>
              </div>
            </td>
          </tr>
          <tr align="left" valign="top">
            ...
            <td width="454" height="22">
              <font color="#000080">
              <input type="text" name="city" maxlength="256" size="30" value="<?php printf($row['city']); ?>"> </font>
            </td>
          </tr>
          <tr align="left" valign="top">
...
?>
              <SELECT NAME="state">
							<option value="<?php printf($state);?>" SELECTED><?php printf($state);?></option>
          ...
          <tr align="left" valign="top">
            ...
            <td width="454" height="22">
              <font color="#000080">
              <input type="text" name="zip" maxlength="256" size="10" value="<?php printf($row['zip']); ?>"> </font>
            </td>
          </tr>
          <tr align="left" valign="top">
...
?>
          ...
          <tr>
		              ...
		              <td width="454" height="22"><font color="#000080">
		              <input type="text" name="cardholdername" size="30" maxlength="65" value="<?php printf($row['cardholdername']); ?>"></font></td>
          </tr>
          <tr align="left" valign="top">
          ...
          <tr align="left" valign="top">
            ...
            <td width="454" height="22"><font color="#000080">
            <input type="text" name="expiration" size="6" maxlength="65" value="<?php printf($row['expiration']); ?>"></font></td>
          </tr>
          <tr align="left" valign="top">
            <td width="216" align="right" height="22"><font color="#000080"><b>*Card Number</b></font></td>
            <td width="454" height="22"><font color="#000080">
            <input type="text" name="cardnum" size="30" maxlength="16" value="<?php printf($row['cardnum']); ?>"></font></td>
          </tr>
...
<?php
// initialize or capture variable
$members_num = !isset($row['members_num'])? NULL : $row['members_num'];
?>
           <select name="Members">
				<option value="<?php printf($members_num);?>" SELECTED><?php printf($members_num);?></option>
...
<?php
// initialize or capture variable
$age = !isset($row['age'])? NULL : $row['age'];
?>
                 <select name="age">
<option value="<?php printf($age);?>" SELECTED><?php printf($age);?></option>
          ...
          <tr align="left" valign="top">
            ...
            <td width="454" height="12">
             <?php
			 // initialize or capture variable
			 $skill_level = !isset($row['skill_level'])? NULL : $row['skill_level'];
?>
             <select name="Skill">
<option value="<?php printf($skill_level);?>" SELECTED><?php printf($skill_level);?></option>
          ...
          <tr align="left" valign="top">
            ...
            <td width="454" height="12">
               <?php
						  // initialize or capture variable
						  $years_active = !isset($row['years_active'])? NULL : $row['years_active'];
			  ?>
            <select name="YearsActive">
<option value="<?php printf($years_active);?>" SELECTED><?php printf($years_active);?></option>
          ...
          <tr align="left" valign="top">
            ...
            <td width="454" height="12">
              <?php
									  // initialize or capture variable
									  $engagement_level = !isset($row['engagement_level'])? NULL : $row['engagement_level'];
			  ?>
              <select name="EngLevel">
<option value="<?php printf($engagement_level);?>" SELECTED><?php printf($engagement_level);?></option>
          ...
          <tr align="left" valign="top">
            ...
            <td width="454" height="52">
              <font color="#000080">
              <textarea name="info" cols="43" rows="9"><?php printf($row['info']); ?></textarea></font>
            </td>
          </tr>
          <tr align="left" valign="top">
...
&nbsp;</td>
 ...
 <?PHP
	...
	printf("Sorry, No Records Found with that ID");
