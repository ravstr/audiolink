    ...
    <td  valign="top" CLASS="maincolor" width="698" style="background-color: #FFFFFF">
     <?PHP
	   	  // echo "<font size=\"2\"><center>Welcome <b>$_SESSION[afirst_name]</b>, you are logged in. <a href=\"logout.php\">Logout</a></center></font>";
    	   	     echo "<font size=\"2\"><center>Welcome <b>$_SESSION[afirst_name]</b>, you are currently logged in. Please click <a href=\"logout.php\">here</a>to logout</center></font>";
   ...
   <tr align="left" valign="top">
   		               ...
   		               <td class="profile" width="603" height="24">
   		                 <div align="left" class="style4">
   		                   <?PHP echo "$rate (total of $row_num $tcount people rated)";?>
   		                 </div>              </td>
            </tr>
              ...
              <tr align="left" valign="top">
                ...
                <tr align="left" valign="top">
                  <td class="profile" width="298" align="center" height="24">
                ...
                <tr align="left" valign="top">
                  ...
                  <td class="profile" width="603" height="24">
                    <span class="style4"> <?PHP echo "$country";?></span></td>
                </tr>
                ...
                <tr align="left" valign="top">
                  ...
                  <td class="profile" width="603" height="24">
                    ...
                    <span class="style4"><?PHP echo "$members_num";?></span>
                 </td>
                ...
                <tr align="left" valign="top">
                  ...
                  <td class="profile" width="603" height="24">
                    <span class="style4"><?PHP echo "$skill_level";?></span>
                ...
                <tr align="left" valign="top">
                  ...
                  <td class="profile" width="603" height="24">
                    <span class="style4"><?PHP echo "$genre";?></span>
                ...
                <tr align="left" valign="top">
                  ...
                  <td class="profile" width="603" height="24">
                    <span class="style4"><?PHP echo "$years_active";?></span>
				 ...
				 <tr align="left" valign="top">
				                  <td class="profile" width="298" align="center" height="24"><b><font color="#000080">Average members age:</font></b></td>
				                  <td class="profile" width="603" height="24">
				                    <span class="style4"><?PHP echo "$age";?></span>
                ...
                <tr align="left" valign="top">
                  ...
                  <td class="profile" width="603" height="24">
                    <span class="style4"><?PHP echo "$engagement_level";?></span>
                ...
                <tr align="left" valign="top">
                  ...
                  score?</font></b></td>
                  <td class="profile" width="603" height="24">
                    <span class="style4"><?PHP echo "$score_perform";?></span>
...
<tr align="left" valign="top">
                  <td class="profile" colspan="2" width="298" align="center" height="24"><font color="#000080"><b>
                  List of Demo Files for <b><?PHP echo "$group_name";?></b></b></font></td>

            </tr>


<tr align="center" valign="top">
               <td class="profile" colspan="2"><font color="#000080"><b>
<?php
...
if (is_dir($dirname)) {
		...
		foreach($files as $filename)
		{
			 if ($filename != "." && $filename != "..") {
					  printf("<a href=\"$dirname/$filename\">$filename</a><br>");
				   }
